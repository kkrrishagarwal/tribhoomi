  ...
  return (
    <div className="mx-auto max-w-screen-xl space-y-4 p-4">
      <div className="flex flex-wrap items-end justify-between gap-2">
        <div>
          <h1 className="text-xl font-semibold">{t("h.builder")} · {data.builder}</h1>
          <p className="text-sm text-slate-600">Unsold units can be edited freely. The moment a unit is assigned to an investor its baseline is locked and every change needs their approval.</p>
        </div>
        <Link href="/" className="btn-ghost">✏️ Draw / upload a new layout on the map</Link>
      </div>
