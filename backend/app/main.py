...
from .routers import ai, dashboard, integrity, layouts, market, parcels, ulpin, units, validate
...
for r in (parcels, units, ulpin, validate, dashboard, ai, integrity, layouts, market):
